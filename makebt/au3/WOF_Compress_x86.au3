#cs ----------------------------------------------------------------------------
 ...
 Program:       WOF_Compress_x86.exe - Version 3.8 in rule 160
...
$hGuiParent = GUICreate(" WOF_Compress x86 - Files Or Folders ", 400, 430, -1, -1, BitXOR($GUI_SS_DEFAULT_GUI, $WS_MINIMIZEBOX))
